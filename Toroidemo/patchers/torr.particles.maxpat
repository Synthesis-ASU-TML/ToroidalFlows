...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 347.0, 438.0, 79.0, 22.0 ],
									"style" : "",
									"text" : "setall 0. 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 305.0, 410.0, 138.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 129.5, 150.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 129.5, 303.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "!-"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 129.5, 331.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 316.0, 361.0, 152.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 129.5, 214.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "unjoin 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 129.5, 277.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "*"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 129.5, 248.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "/"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 50.0, 189.0, 53.0, 22.0 ],
									"style" : "",
									"text" : "unjoin 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 129.5, 185.0, 154.0, 22.0 ],
									"style" : "",
									"text" : "zl iter 4 @zlmaxsize 10000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 129.5, 123.0, 78.0, 22.0 ],
									"style" : "",
									"text" : "route setPos"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.5, 100.0, 80.0, 22.0 ],
									"style" : "",
									"text" : "r #0-particles"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 316.0, 525.228027, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 734.0, 756.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 734.0, 785.0, 93.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 537.0, 814.0, 216.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, -12.0, 82.0, 22.0 ],
					"style" : "",
					"text" : "s #0-particles"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, -42.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "s #0-error"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2463.0, 1533.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "r #0-error"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2463.0, 1561.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-28", 0 ],
					"midpoints" : [ 546.5, 837.0, 507.0, 837.0, 507.0, 693.0, 412.5, 693.0 ],
					"order" : 1,
					"source" : [ "obj-389", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 645.0, 848.0, 764.0, 848.0, 764.0, 809.0, 731.0, 809.0, 731.0, 782.0, 743.5, 782.0 ],
					"source" : [ "obj-389", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 546.5, 837.0, 519.0, 837.0, 519.0, 459.0, 425.5, 459.0 ],
					"order" : 0,
					"source" : [ "obj-389", 0 ]
				}
